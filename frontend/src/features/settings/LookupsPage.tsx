...
const tabs = [
  ...
  { label: 'Origins', entityName: 'Origin', hooks: originHooks,
    columns: [{ field: 'name', headerName: 'Name', flex: 1 }, { field: 'country', headerName: 'Country', flex: 1 }, { field: 'region', headerName: 'Region', flex: 1 }],
    fields: [{ name: 'name', label: 'Name', required: true }, { name: 'country', label: 'Country' }, { name: 'region', label: 'Region' }] },
  ...
  { label: 'Process Methods', entityName: 'Process Method', hooks: processMethodHooks,
    columns: [{ field: 'name', headerName: 'Name', flex: 1 }, { field: 'category', headerName: 'Category', width: 150 }],
    fields: [{ name: 'name', label: 'Name', required: true }, { name: 'category', label: 'Category' }] },
  { label: 'Bean Varieties', entityName: 'Bean Variety', hooks: beanVarietyHooks,
    columns: [{ field: 'name', headerName: 'Name', flex: 1 }, { field: 'species', headerName: 'Species', width: 150 }],
    fields: [{ name: 'name', label: 'Name', required: true }, { name: 'species', label: 'Species' }] },
  ...
  { label: 'Vendors', entityName: 'Vendor', hooks: vendorHooks,
    columns: [{ field: 'name', headerName: 'Name', flex: 1 }, { field: 'url', headerName: 'URL', flex: 1 }, { field: 'location', headerName: 'Location', flex: 1 }],
    fields: [{ name: 'name', label: 'Name', required: true }, { name: 'url', label: 'URL' }, { name: 'location', label: 'Location' }, { name: 'notes', label: 'Notes' }] },
